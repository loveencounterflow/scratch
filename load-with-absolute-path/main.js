...
(function() {
  ...
  this._compile_options = function() {
    ...
    var cache_locator, cache_route, key, ref, route;
  ...
  this.write_mkts_settings = function(handler) {
    return step((function(_this) {
      return function*(resume) {
        var defs, filename, fontspec_version, home, i, len, lines, name, newcommands, ref, ref1, settings_locator, texname, text, use_new_syntax, value;
        lines = [];
