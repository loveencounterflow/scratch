...
mkts_backslash_escaping = ->
  ...
  # #-----------------------------------------------------------------------------------------------------------
  # @escape.cloak_escape_chrs = ( S, text ) =>
  #   R = text
  ...
  # #-----------------------------------------------------------------------------------------------------------
  # @escape.uncloak_escape_chrs = ( S, text ) =>
  #   R = text
  ...
  # #-----------------------------------------------------------------------------------------------------------
  # @escape.cloak_backslashed_chrs = ( S, text ) =>
  #   R = text
  #   R = R.replace /// \\ ( (?: [  \ud800-\udbff ] [ \udc00-\udfff ] ) | . ) ///g, ( _, $1 ) ->
  ...
  # #-----------------------------------------------------------------------------------------------------------
  # @escape.uncloak_backslashed_chrs = ( S, text ) =>
  #   R = text
  ...
  # #-----------------------------------------------------------------------------------------------------------
  # @escape.remove_backslashes = ( S, text ) =>
  ...
  log '2', CND.rainbow ( cloaked_text   = @escape.cloak_escape_chrs         null, cloaked_text )
  log '3', CND.rainbow ( cloaked_text   = @escape.cloak_backslashed_chrs    null, cloaked_text )
  uncloaked_text = cloaked_text
  log '4', CND.rainbow ( uncloaked_text = @escape.uncloak_backslashed_chrs  null, uncloaked_text )
  log '5', CND.rainbow ( uncloaked_text = @escape.uncloak_escape_chrs       null, uncloaked_text )
  # log '7', CND.rainbow '©79011', @escape.remove_backslashes               null, uncloaked_text
