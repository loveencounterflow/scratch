...
(function() {
  var CND, TEXT, after, alert, badge, debug, dynamic_buffer, echo, eventually, every, f, fix_remarkably, g, help, immediately, info, iterate_over_maps, log, njs_fs, njs_path, njs_util, rainbow, rpr, step, suspend, test_archiver, test_bloem, test_bloom_stream, test_bloom_stream2, test_codepoints, test_hollerith_codec, test_keys, test_symbol_as_error, test_xregexp3, try_lazy_require, try_slicing_html, urge, warn, whisper,
