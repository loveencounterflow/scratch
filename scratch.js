...
(function() {
  ...
  mkts_backslash_escaping = function() {
    var cloaked_text, metaesc_mc_backslash, metaesc_mc_macro, metaesc_mc_master, metaesc_mc_stop, metaesc_oc_backslash, metaesc_rp_backslash, metaesc_rp_macro, metaesc_rp_master, metaesc_sp_backslash, metaesc_sp_macro, metaesc_sp_master, metaesc_tsc_backslash, metaesc_tsc_macro, metaesc_tsc_master, text, uncloaked_text;
    this.escape = {};

    /* `mc`: 'meta character' */
    metaesc_mc_master = '%';
    metaesc_mc_backslash = '&';
    metaesc_mc_macro = '!';
    metaesc_mc_stop = ';';
    metaesc_oc_backslash = '\\';

    /* `sp`: 'source pattern' */
    metaesc_sp_master = RegExp("" + metaesc_mc_master, "g");
    metaesc_sp_backslash = RegExp("" + metaesc_mc_backslash, "g");
    metaesc_sp_macro = RegExp("" + metaesc_mc_macro, "g");

    /* `tsc`: 'target sequence character' */
    metaesc_tsc_master = metaesc_mc_master + "A";
    metaesc_tsc_backslash = metaesc_mc_master + "B";
    metaesc_tsc_macro = metaesc_mc_master + "C";

    /* `rp`: 'resolution pattern' */
    metaesc_rp_master = RegExp("" + metaesc_ts_master, "g");
    metaesc_rp_backslash = RegExp("" + metaesc_ts_backslash, "g");
    metaesc_rp_macro = RegExp("" + metaesc_ts_macro, "g");
    this.escape.cloak_escape_chrs = (function(_this) {
      return function(S, text) {
        var R;
        R = text;
        R = R.replace(metaesc_sp_master, metaesc_tsc_master);
        R = R.replace(metaesc_sp_backslash, metaesc_tsc_backslash);
        R = R.replace(metaesc_sp_macro, metaesc_tsc_macro);
        return R;
      };
    })(this);
    this.escape.uncloak_escape_chrs = (function(_this) {
      return function(S, text) {
        var R;
        R = text;
        R = R.replace(metaesc_rp_macro, metaesc_mc_macro);
        R = R.replace(metaesc_rp_backslash, metaesc_mc_backslash);
        R = R.replace(metaesc_rp_master, metaesc_mc_master);
        return R;
      };
    })(this);
    text = "some <<unlicensed>> stuff here. \\𠄨 &%!%A&123;\nsome more \\\\<<unlicensed\\\\>> stuff here.\nsome \\<<licensed\\>> stuff here, and <\\<\nThe <<<\\LaTeX{}>>> Logo: `<<<\\LaTeX{}>>>`";
    cloaked_text = text;
    ...
    if (uncloaked_text !== text) {
      log('6', CND.rainbow('©79011', "!!!"));
    }
    return log(CND.yellow('########################################################################'));
  };
